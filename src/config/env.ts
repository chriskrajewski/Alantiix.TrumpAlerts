...
const envSchema = z.object({
  ...
  TRUTHSOCIAL_PROXY_URL: z.string().url().optional(),
  TRUTHSOCIAL_USERNAME: z.string().min(1).optional(),
  TRUTHSOCIAL_PASSWORD: z.string().min(1).optional(),
  TRUTHSOCIAL_TOKEN: z.string().min(1).optional(),
